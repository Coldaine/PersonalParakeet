...
class TestClipboardManagerBase(unittest.TestCase):
    ...
    def test_clipboard_manager_is_abstract(self):
        """Test that ClipboardManager has abstract methods"""
        # ClipboardManager can be instantiated, but calling abstract methods should raise
        manager = ClipboardManager()
        with self.assertRaises(NotImplementedError):
            manager._get_clipboard_content()
            
    def test_save_clipboard_requires_implementation(self):
        """Test that _get_clipboard_content must be implemented"""
        manager = ClipboardManager()
        with self.assertRaises(NotImplementedError):
            manager.save_clipboard()
            
    def test_restore_clipboard_requires_implementation(self):
        """Test that _set_clipboard_content must be implemented"""
        manager = ClipboardManager()
        manager.original_content = "test"
        with self.assertRaises(NotImplementedError):
            manager.restore_clipboard()
...
class TestLinuxClipboardManager(unittest.TestCase):
    ...
    def test_save_clipboard_with_xclip(self, mock_run):
        ...
        self.manager.clipboard_tool = 'xclip'
    ...
    def test_save_clipboard_with_xsel(self, mock_run):
        ...
        self.manager.clipboard_tool = 'xsel'
        mock_run.return_value = MagicMock(stdout='test content')
