...
class TestMainApplication(BaseHardwareTest):
    ...
    def test_configuration_loading_and_validation(self):
        ...
        assert config.thought_linking.enabled is True, "Thought linking should be enabled by default"
    ...
    def test_emergency_cleanup_with_real_subprocess(self):
        ...
        cleanup_script_path = Path(__file__).parent.parent / "src" / "personalparakeet" / "cleanup_processes.py"
