...
class TestReporter:
    ...
    def _save_report(self, summary: Dict[str, Any]):
        ...
        report = {"summary": summary, "test_results": self.test_results}
    ...
    def _save_readable_report(self, summary: Dict[str, Any]):
        ...
        lines.extend(["", "Performance Metrics:", "-" * 30])
        ...
        for result in self.test_results:
            ...
            if result.get("resource_usage"):
                ...
                if "cpu_percent" in usage:
                    lines.append(
                        f"    CPU: {usage['cpu_percent'].get('avg', 0):.1f}% avg, {usage['cpu_percent'].get('max', 0):.1f}% max"
                    )
