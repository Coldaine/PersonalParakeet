...
class ResourceMonitor:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        metrics = {
            ...
            "gpu_utilization": [s.gpu_utilization for s in self.samples if s.gpu_utilization is not None]
        }
    ...
    def get_peak_usage(self) -> Dict[str, float]:
        ...
        if self.samples:
            ...
            gpu_util_values = [s.gpu_utilization for s in self.samples if s.gpu_utilization is not None]
            if gpu_util_values:
