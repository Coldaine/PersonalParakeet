...
def main():
    ...
    # Define tests
    tests = [
        ("Live Audio Monitor", root_dir / "src/personalparakeet/tests/utilities/test_live_audio.py"),
        ("Full Pipeline Test", root_dir / "src/personalparakeet/tests/utilities/test_full_pipeline.py"),
