...
class CUDACompatibility:
    ...
    def _add_recommendations(info: CUDAInfo):
        ...
        if not info.available:
            info.recommendations.append("No CUDA available - will use CPU (slower performance)")
            return
        ...
        if info.pytorch_cuda_version:
            ...
            if cuda_major < 11:
                info.recommendations.append("CUDA version is old - consider upgrading PyTorch")
