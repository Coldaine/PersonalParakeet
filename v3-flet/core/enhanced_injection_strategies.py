...
class EnhancedWin32SendInputStrategy(BaseInjectionStrategy):
    ...
    def _send_unicode_char(self, char: str) -> bool:
        ...
        try:
            import ctypes
            char_code = ord(char)
            ctypes.windll.user32.SendInput(1, ctypes.byref(ctypes.c_uint(char_code)), ctypes.sizeof(ctypes.c_uint))
            return True
        except Exception:
            return False
...
class EnhancedInjectionManager:
    ...
    def _try_inject_with_strategy(self, strategy: BaseInjectionStrategy, text: str, 
